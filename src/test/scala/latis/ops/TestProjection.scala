...
//  }
  ...
  def project_scalar_alt_form {
    ...
    ds2 match {
      case Dataset(v) => assertEquals("b", v.asInstanceOf[Tuple].getVariables(0).getName)
      case _ => fail()
    }
  }
...
//  }
  ...
  def project_scalar_in_tuple {
    ...
    val ds = proj(tup)
    ds match {
      case Dataset(v) => assertEquals(1, v.asInstanceOf[Tuple].getElementCount)
      case _ => fail()
    }
  }
  ...
  def project_scalar_in_function_tuple_range {
    ...
    //TODO: test same domain: val domain = ds.getVariableByIndex(0).asInstanceOf[Function].domain
    ds2 match {
      case Dataset(v) => assertEquals(1, v.asInstanceOf[Function].getRange.asInstanceOf[Tuple].getElementCount)
      case _ => fail()
    }
  }
  ...
  def project_scalar_in_function_function_range {
    ...
    val ds2 = proj(ds1)
    ds2 match {
      case Dataset(v) => assertEquals(1, v.asInstanceOf[Function].getRange.asInstanceOf[Function].getRange.asInstanceOf[Tuple].getElementCount)
      case _ => fail()
    }
  }
