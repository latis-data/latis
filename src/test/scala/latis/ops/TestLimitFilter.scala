...
class TestLimitFilter {
  ...
  def test_canonical = {
    ...
    val exp1 = Dataset(Function(Time(Metadata(md)), Tuple(Integer(Metadata("myInt")), Real(Metadata("myReal")), Text(Metadata("myText"))), Iterator.empty), TestDataset.canonical.getMetadata)
    ...
    val exp3 = Dataset(Function(List(Sample(Time(Metadata(md), "1970/01/01"), Tuple(Integer(Metadata("myInt"), 1), Real(Metadata("myReal"), 1.1), Text(Metadata("myText"), "A"))),
    ...
    assertEquals(exp1, LimitFilter(0)(TestDataset.canonical))
    assertEquals(exp2, LimitFilter(1)(TestDataset.canonical))
    assertEquals(exp3, LimitFilter(5)(TestDataset.canonical))
  }
  @Test
  def test_empty = {
  ...
  def test_tuple_of_functions = {
    val exp1 = Dataset(Tuple(for (i <- 0 until 4) yield Function(Integer(Metadata("myInt"+i)), Real(Metadata("myReal"+i)), Iterator.empty), Metadata("tuple_of_functions")), TestDataset.tuple_of_functions.getMetadata)
    ...
    val exp3 = Dataset(Tuple(for (i <- 0 until 4) yield Function((0 until 3).map(j =>
      Sample(Integer(Metadata("myInt"+i), 10 + j), Real(Metadata("myReal"+i), 10 * i + j)))), Metadata("tuple_of_functions")), TestDataset.tuple_of_functions.getMetadata)
    assertEquals(exp1, LimitFilter(0)(TestDataset.tuple_of_functions))
    assertEquals(exp2, LimitFilter(1)(TestDataset.tuple_of_functions))
    assertEquals(exp3, LimitFilter(5)(TestDataset.tuple_of_functions))
  }
  @Test
  ...
  def test_mixed_tuple = {
    val exp1 = Dataset(Tuple(Real(Metadata("myReal"), 0.0), Tuple(Integer(Metadata("myInteger"), 0), Real(Metadata("myReal"), 0)), Function(Real(Metadata("unknown")), Real(Metadata("unknown")), Iterator.empty)), TestDataset.mixed_tuple.getMetadata)
    ...
    val exp3 = Dataset(Tuple(Real(Metadata("myReal"), 0.0), Tuple(Integer(Metadata("myInteger"), 0), Real(Metadata("myReal"), 0)), Function(List(Sample(Real(0), Real(0)), 
                       Sample(Real(1), Real(1)), 
                       Sample(Real(2), Real(2))))), TestDataset.mixed_tuple.getMetadata)
    assertEquals(exp1, LimitFilter(0)(TestDataset.mixed_tuple))
    assertEquals(exp2, LimitFilter(1)(TestDataset.mixed_tuple))
    assertEquals(exp3, LimitFilter(5)(TestDataset.mixed_tuple))
  }
  @Test
  def test_function_of_scalar = {
    val exp1 = Dataset(Function(Real(Metadata("unknown")), Real(Metadata("unknown")), Iterator.empty), TestDataset.function_of_scalar.getMetadata)
  ...
  def test_function_of_tuple = {
    val exp1 = Dataset(Function(Integer(Metadata("unknown")), Tuple(Real(Metadata("unknown")), Text(Metadata("unknown"))), Iterator.empty), TestDataset.function_of_tuple.getMetadata)
  ...
  def test_function_of_function = {
    val exp1 = Dataset(Function(Integer(Metadata("x")), Function(Integer(Metadata("y")), Real(Metadata("z")), Iterator.empty), Iterator.empty, Metadata("function_of_functions_with_data_in_scalar")), TestDataset.function_of_functions.getMetadata)
  ...
  def test_mixed_function = {
    val exp1 = Dataset(Function(Real(Metadata("myReal")), Tuple(Tuple(Integer(Metadata("myInteger")), Real(Metadata("myReal"))), Function(Real(Metadata("unknown")), Real(Metadata("unknown")), Iterator.empty)), Iterator.empty), TestDataset.mixed_function.getMetadata)
  ...
  def test_index_function = {
    val exp1 = Dataset(Function(Index(), Integer(Metadata("unknown")), Iterator.empty), TestDataset.index_function.getMetadata)
    val exp2 = Dataset(Function(List(Integer(1))), TestDataset.index_function.getMetadata)
    val exp3 = Dataset(Function(List(Integer(1), Integer(2))), TestDataset.index_function.getMetadata)
  ...
  @Test
  def test_combo = {
    val exp1 = Dataset(List(Function(Integer(Metadata("unknown")), Tuple(Real(Metadata("unknown")), Text(Metadata("unknown"))), Iterator.empty), TestDataset.tuple_of_tuples.getVariables(0), TestDataset.text.getVariables(0)), TestDataset.combo.getMetadata)
