...
class TestLimitFilter {
  ...
  def test_canonical = {
    ...
    val exp1 = Dataset(Function(Time(Metadata(md)), Tuple(Integer(Metadata("myInt")), Real(Metadata("myReal")), Text(Metadata("myText"))), Iterator.empty, Metadata(Map("length" -> 0.toString))), TestDataset.canonical.getMetadata)
    val exp2 = Dataset(Function(List(Sample(Time(Metadata(md), "1970/01/01"), Tuple(Integer(Metadata("myInt"), 1), Real(Metadata("myReal"), 1.1), Text(Metadata("myText"), "A")))), Metadata(Map("length" -> 1.toString))), TestDataset.canonical.getMetadata)
  ...
  def test_function_of_scalar = {
    val exp1 = Dataset(Function(Real(Metadata("unknown")), Real(Metadata("unknown")), Iterator.empty, Metadata(Map("length" -> 0.toString))), TestDataset.function_of_scalar.getMetadata)
  ...
  def test_function_of_tuple = {
    val exp1 = Dataset(Function(Integer(Metadata("unknown")), Tuple(Real(Metadata("unknown")), Text(Metadata("unknown"))), Iterator.empty, Metadata(Map("length" -> 0.toString))), TestDataset.function_of_tuple.getMetadata)
  ...
  def test_function_of_function = {
    val exp1 = Dataset(Function(Integer(Metadata("x")), Function(Integer(Metadata("y")), Real(Metadata("z")), Iterator.empty, Metadata(Map("length" -> 0.toString))), Iterator.empty, Metadata(Map("name" -> "function_of_functions_with_data_in_scalar", "length" -> 0.toString))), TestDataset.function_of_functions.getMetadata)
    val exp2 = Dataset(Function(List(Sample(Integer(Metadata("x"), 0), Function((0 until 3).map(j => 
      Sample(Integer(Metadata("y"), 10 + j), Real(Metadata("z"), 10 * 0 + j)))))), Metadata(Map("name" -> "function_of_functions_with_data_in_scalar", "length" -> 1.toString))), TestDataset.function_of_functions.getMetadata)
    val exp3 = Dataset(Function((0 until 4).map(Integer(Metadata("x"), _)), for (i <- 0 until 4) yield Function((0 until 3).map(j => 
      Sample(Integer(Metadata("y"), 10 + j), Real(Metadata("z"), 10 * i + j)))), Metadata(Map("name" -> "function_of_functions_with_data_in_scalar", "length" -> 4.toString))), TestDataset.function_of_functions.getMetadata)
  ...
  def test_mixed_function = {
    val exp1 = Dataset(Function(Real(Metadata("myReal")), Tuple(Tuple(Integer(Metadata("myInteger")), Real(Metadata("myReal"))), TestDataset.function_of_scalar.getVariables(0)), Iterator.empty, Metadata(Map("length" -> 0.toString))), TestDataset.mixed_function.getMetadata)
    ...
    val exp3 = Dataset(Function(List(Sample(Real(Metadata("myReal"), 0.0), Tuple(Tuple(Integer(Metadata("myInteger"), 0), Real(Metadata("myReal"), 0)), (TestDataset.function_of_scalar+(0)).getVariables(0))),
  ...
  def test_index_function = {
    val exp1 = Dataset(Function(Index(), Integer(Metadata("unknown")), Iterator.empty, Metadata(Map("length" -> 0.toString))), TestDataset.index_function.getMetadata)
  ...
  @Test
  def test_combo = {
    val exp1 = Dataset(List(Function(Integer(Metadata("unknown")), Tuple(Real(Metadata("unknown")), Text(Metadata("unknown"))), Iterator.empty, Metadata(Map("length" -> 0.toString))), TestDataset.tuple_of_tuples.getVariables(0), TestDataset.text.getVariables(0)), TestDataset.combo.getMetadata)
