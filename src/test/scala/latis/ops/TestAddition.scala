...
class TestAddition {
  ...
  @Test
  def test_real_value {
    assertEquals(6.28, (3.14 + TestDataset.real).getVariables(0).getNumberData.doubleValue, 0.0)
  }
  @Test
  def test_real_md {
  ...
  def test_integer_value {
    assertEquals(40, ((-2) + TestDataset.integer).getVariables(0).getNumberData.intValue)
  }
  @Test
  def test_integer_md {
  ...
  @Test
  def test_time {
    assertEquals(1500.0, (TestDataset.real_time + 500).getVariables(0).getNumberData.doubleValue, 0.0)
  }
  @Test
